...
public final class FilterUtils {
    ...
    public static Filter getStarLitFilter(Context context) {
        ...
        Filter filter = new Filter(context.getString(R.string.starlit));
    ...
    public static Filter getBlueMessFilter(Context context) {
        ...
        Filter filter = new Filter(context.getString(R.string.bluemess));
    ...
    public static Filter getAweStruckVibeFilter(Context context) {
        ...
        Filter filter = new Filter(context.getString(R.string.struck));
    ...
    public static Filter getLimeStutterFilter(Context context) {
        ...
        Filter filter = new Filter(context.getString(R.string.lime));
    ...
    public static Filter getNightWhisperFilter(Context context) {
        ...
        Filter filter = new Filter(context.getString(R.string.whisper));
